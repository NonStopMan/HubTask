...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fluxStandardAction = __webpack_require__(199);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lodashIsplainobject = __webpack_require__(200);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _postList = __webpack_require__(206);
...
/***/ (function(module, exports, __webpack_require__) {
	    ...
	    _createClass(PostList, [{
	        ...
	        value: function renderList() {
	            ...
	            return this.props.posts.map(function (post) {
	                return _react2.default.createElement(
	                    'div',
	                    { className: '', key: post.postId },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'row border border-dark rounded post-panel' },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'co2-sm-3 col-md-3 col-lg-1' },
	                            _react2.default.createElement('img', { src: '/images/profilePhoto.png', className: 'post-image rounded-circle' })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-sm-7 col-md-7 col-lg-10' },
	                            post.content
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-sm-2 col-md-2 col-lg-1 read-button' },
	                            _react2.default.createElement(
	                                'button',
	                                { type: 'button', className: 'btn btn-primary',
	                                    onClick: function onClick() {
	                                        return _this2.props.readPost(post.postId);
	                                    }
	                                },
	                                'Read'
	                            )
	                    ...
	                    _react2.default.createElement('div', { className: 'post-spliter' })
	                );
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement('div', { className: 'col-sm-7 col-md-6 col-lg-9' }),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-sm-5 col-md-6 col-lg-3 posts-lenght' },
	                        'Number of un-read Post is (',
	...
	function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({ getPosts: _index.getPosts, readPost: _index.readPost }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.READ_POST = exports.FETCH_POSTS = undefined;
	...
	var ROOT_URL = '/api/posts';
	var FETCH_POSTS = exports.FETCH_POSTS = 'FETCH_POSTS';
	var READ_POST = exports.READ_POST = 'READ_POST';

	function getPosts() {
	    var url = ROOT_URL + '/get-user-posts';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _postsReducer = __webpack_require__(235);
